...
- trải nghiệm Web theo phong cách  xuyên suốt Home, Explore, Entity Detail, Chat, Recommendation, 3D và audio.
...
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| UX/UI design       | Figma, FigJam; Tapestry-inspired public design system                                                                                           |
| Public frontend    | Next.js 14 App Router, React 18, TypeScript; custom Tapestry-style composition, Ant Design/Ant Design X chỉ làm component primitive khi phù hợp |
...
### Public UI Design Direction — Tapestry-style

Tapestry là **visual language của toàn bộ giao diện người dùng**, không phải chỉ là cách trình bày Entity Detail. Home, Explore, Entity Detail, Chat, Recommendation và Multimedia phải tạo cảm giác như một tấm thảm kể chuyện văn hóa liên tục:
...
Admin Knowledge Studio không dùng bố cục Tapestry. Admin ưu tiên Ant Design dashboard/form/table rõ ràng, mật độ thông tin cao và thao tác an toàn.
...
| Route                 | Chức năng                                                                                        |
| --------------------- | ------------------------------------------------------------------------------------------------ |
| `/`                   | Tapestry-style Home: visual stories, search, featured content, category/region và recommendation |
| `/explore`            | Tapestry-style discovery canvas với search/filter và linked heritage cards                       |
| `/explore/[entityId]` | Tapestry-style Entity Detail: narrative, claims, timeline, relations, sources, map và media      |
| `/chat`               | Grounded HeritageGraph assistant trong cùng Tapestry visual language                             |
| `/account`            | Profile, consent, privacy và export/delete data với public design system nhất quán               |
...
- Tapestry-style Public Heritage Portal xuyên suốt Home, Explore, Entity Detail, Chat và Recommendation;
...
| ------------------------- | ------------------------------------ | --------------------------------------------------------------- |
| ThS. Nguyễn Thị Thanh Tâm | Project Supervisor                   | [ttamdtu@gmail.com](mailto:ttamdtu@gmail.com)                   |
| Dương Thanh Hùng          | Project Leader / AI Backend Engineer | [hungthanhhung37@gmail.com](mailto:hungthanhhung37@gmail.com)   |
| Cao Văn Khoa              | Data and Knowledge Engineer          | [caovankhoa11@gmail.com](mailto:caovankhoa11@gmail.com)         |
| Đào Hồ Anh Tùng           | UI/UX and Public Frontend Developer  | [daohoanhtung@gmail.com](mailto:daohoanhtung@gmail.com)         |
| Lê Anh Nghĩa              | UI/UX and Admin Frontend Developer   | [leanhnghia23@gmail.com](mailto:leanhnghia23@gmail.com)         |
| Dương Bảo Ngọc            | QA and Documentation                 | [ngocduong.200011@gmail.com](mailto:ngocduong.200011@gmail.com) |
...
- Figma và design system Tapestry-style cho toàn bộ Public Portal;
...
- hỗ trợ Account/Profile/Privacy UI khi Admin critical path đã ổn định.
...
| Epic 3 — Public Heritage Portal                | Người dùng tìm và chọn published content qua Home, Explore/Library, Map 2D và Content Landing                |
| Epic 4 — Grounded Heritage Assistant           | Người dùng nhận answered/clarify/abstained với citation hợp lệ                                               |
| Epic 5 — Scene, 3D and Multimedia Experience   | Người dùng đi qua guided scenes với 3D, audio, transcript và media có provenance                             |
| Epic 6 — Explainable Personalized Discovery    | Người dùng nhận recommendation có reason path và kiểm soát dữ liệu cá nhân                                   |
...
6. Figma foundations, Tapestry-style public design system, public/admin shells và API mocks;
...
- Figma information architecture, Tapestry visual direction, design tokens và low-fidelity critical flows;
...
- Tapestry-style Home, navigation, search entry và featured story sections;
...
- Tapestry-style Explore discovery canvas, search và filters;
- Tapestry-style Entity Detail với narrative, claims, timeline, relations và sources;
...
- Account/Profile/Privacy minimum flow;
...
- privacy/export/delete cho dữ liệu cá nhân đã lưu.
...
- HttpOnly/Secure/SameSite cookies for authenticated sessions;
- least-privilege IAM;
- secrets outside source control;
- authenticated admin write paths;
- consent before interaction tracking;
- user export/delete for stored personal data;
...
| 8   | Recommendation Module                    | Cold start, profile-based ranking, diversity và reason path                                            |
| 9   | Public Heritage Experience               | Tapestry-style Home, Explore, Entity Detail, Chat, recommendation, map, timeline và one 3D/audio pilot |
...
3. Public Home, Explore, Entity Detail, Chat và Recommendation sử dụng nhất quán Tapestry visual language và published data;
...
1. Lewis, P., et al. (2020). *Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks.* NeurIPS 2020. [https://arxiv.org/abs/2005.11401](https://arxiv.org/abs/2005.11401)
