...
- Prompt lấy từ apps/backend/core/prompt.py và đi qua chat template của tokenizer.
...
Usage:
  ...
  python pipelines/training/score_gold.py --adapter models/peft-adapter \
    --checkpoint 75 --gold ./pipelines/evaluation/gold.jsonl --out ./pipelines/evaluation/report_ck75.json
"""
...
from apps.backend.core.prompt import NER_QUESTION, NER_TYPES, SYSTEM, chat_messages  # noqa: E402
from pipelines.training.train_hf import load_config  # noqa: E402
...
REFUSAL_MARKERS = [
    ...
    # pipelines/evaluation/gold.jsonl: 3/15 mẫu bị tính SAI chỉ vì danh sách marker không có chúng
