...
pipelines/training/bootstrap_deep_qa.py (dữ liệu lấy từ corpus Huế - Đà Nẵng đã crawl);
các mẫu ở đây là ví dụ ngoài miền (Bát Tràng, Đường Lâm) nên đừng train thật
bằng file này.

Chạy: python pipelines/training/make_smoke_data.py
"""
import json
import sys
...
from apps.backend.core.prompt import SYSTEM  # noqa: E402
